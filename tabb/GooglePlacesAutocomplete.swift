...
@objc public protocol GooglePlacesAutocompleteDelegate {
    ...
    //optional func returnToInseguridad(controller:ZonasInseguridadViewController, pay:String)
}
...
public class GooglePlacesAutocomplete: UINavigationController {
    ...
    public var descartarButton: UIBarButtonItem!
    public var notNow = false
    var avance = false
    ...
    public convenience init(apiKey: String, placeType: PlaceType = .All) {
        ...
        closeButton = UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.Done, target: self, action: "close")
        closeButton.style = UIBarButtonItemStyle.Done
        
        descartarButton = UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.Cancel, target: self, action: "descartar")
        descartarButton.style = UIBarButtonItemStyle.Bordered
        
        gpaViewController.navigationItem.leftBarButtonItem = closeButton
        gpaViewController.navigationItem.rightBarButtonItem = descartarButton
        
        gpaViewController.navigationItem.title = "Reporte de incidencia"
    }
    
    func close() {
        
        if gpaViewController.descripcion!.text != "" && gpaViewController.searchDisplayController?.searchBar.text != "" {
            avance == true
            print(avance)
            ...
            alert.title = "Faltan datos"
            alert.message = "Complete ambos campos por favor"
...
public class GooglePlacesAutocompleteContainer: UIViewController {
    ...
    @IBAction func descartar(sender: AnyObject) {
